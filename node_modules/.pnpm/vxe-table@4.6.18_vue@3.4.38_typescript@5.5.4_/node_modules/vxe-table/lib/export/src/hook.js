...
const tableExportHook = {
  setupTable($xetable) {
    ...
    const handleExportAndPrint = (options, isPrint) => {
      ...
      const types = defOpts.types || _vXETable.VXETable.globalConfs.exportTypes;
    ...
    const exportMethods = {
      ...
      importData(options) {
        ...
        return (0, _util2.readLocalFile)(opts).catch(e => {
          if (afterImportMethod) {
            afterImportMethod({
              status: false,
              options: opts,
...
var _default = exports.default = tableExportHook;