...
.vxe-form--item-content > .vxe-form--item-col_1,
.vxe-form--item-row > .vxe-form--item-col_1 {
  width: 4.16667%;
}
.vxe-form--item-content > .vxe-form--item-col_2,
.vxe-form--item-row > .vxe-form--item-col_2 {
  width: 8.33333%;
}
.vxe-form--item-content > .vxe-form--item-col_3,
.vxe-form--item-row > .vxe-form--item-col_3 {
  width: 12.5%;
}
.vxe-form--item-content > .vxe-form--item-col_4,
.vxe-form--item-row > .vxe-form--item-col_4 {
  width: 16.66667%;
}
.vxe-form--item-content > .vxe-form--item-col_5,
.vxe-form--item-row > .vxe-form--item-col_5 {
  width: 20.83333%;
}
.vxe-form--item-content > .vxe-form--item-col_6,
.vxe-form--item-row > .vxe-form--item-col_6 {
  width: 25%;
}
.vxe-form--item-content > .vxe-form--item-col_7,
.vxe-form--item-row > .vxe-form--item-col_7 {
  width: 29.16667%;
}
.vxe-form--item-content > .vxe-form--item-col_8,
.vxe-form--item-row > .vxe-form--item-col_8 {
  width: 33.33333%;
}
.vxe-form--item-content > .vxe-form--item-col_9,
.vxe-form--item-row > .vxe-form--item-col_9 {
  width: 37.5%;
}
.vxe-form--item-content > .vxe-form--item-col_10,
.vxe-form--item-row > .vxe-form--item-col_10 {
  width: 41.66667%;
}
.vxe-form--item-content > .vxe-form--item-col_11,
.vxe-form--item-row > .vxe-form--item-col_11 {
  width: 45.83333%;
}
.vxe-form--item-content > .vxe-form--item-col_12,
.vxe-form--item-row > .vxe-form--item-col_12 {
  width: 50%;
}
.vxe-form--item-content > .vxe-form--item-col_13,
.vxe-form--item-row > .vxe-form--item-col_13 {
  width: 54.16667%;
}
.vxe-form--item-content > .vxe-form--item-col_14,
.vxe-form--item-row > .vxe-form--item-col_14 {
  width: 58.33333%;
}
.vxe-form--item-content > .vxe-form--item-col_15,
.vxe-form--item-row > .vxe-form--item-col_15 {
  width: 62.5%;
}
.vxe-form--item-content > .vxe-form--item-col_16,
.vxe-form--item-row > .vxe-form--item-col_16 {
  width: 66.66667%;
}
.vxe-form--item-content > .vxe-form--item-col_17,
.vxe-form--item-row > .vxe-form--item-col_17 {
  width: 70.83333%;
}
.vxe-form--item-content > .vxe-form--item-col_18,
.vxe-form--item-row > .vxe-form--item-col_18 {
  width: 75%;
}
.vxe-form--item-content > .vxe-form--item-col_19,
.vxe-form--item-row > .vxe-form--item-col_19 {
  width: 79.16667%;
}
.vxe-form--item-content > .vxe-form--item-col_20,
.vxe-form--item-row > .vxe-form--item-col_20 {
  width: 83.33333%;
}
.vxe-form--item-content > .vxe-form--item-col_21,
.vxe-form--item-row > .vxe-form--item-col_21 {
  width: 87.5%;
}
.vxe-form--item-content > .vxe-form--item-col_22,
.vxe-form--item-row > .vxe-form--item-col_22 {
  width: 91.66667%;
}
.vxe-form--item-content > .vxe-form--item-col_23,
.vxe-form--item-row > .vxe-form--item-col_23 {
  width: 95.83333%;
}
.vxe-form--item-content > .vxe-form--item-col_24,
...
.vxe-form--item.is--padding {
  padding: 0.6em;
}
.vxe-form--item.is--padding.is--vertical {
  padding: 0.4em 0.6em;
}
.vxe-form--item.is--bold > .vxe-form--item-inner > .vxe-form--item-title {
  font-weight: bold;
}
