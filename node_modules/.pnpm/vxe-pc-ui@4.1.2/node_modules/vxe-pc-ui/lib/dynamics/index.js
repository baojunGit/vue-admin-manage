...
const VxeDynamics = (0, _vue.defineComponent)({
  setup() {
    return () => {
      ...
      }, drawers.map(item => (0, _vue.h)((0, _vue.resolveComponent)('vxe-drawer'), item))) : (0, _vue.createCommentVNode)(), globalLoading ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-loading'), globalLoading) : (0, _vue.createCommentVNode)()];
    };
  }
});
