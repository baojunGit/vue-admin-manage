...
exports.WidgetVxeSelectFormComponent = void 0;
...
const WidgetVxeSelectFormComponent = exports.WidgetVxeSelectFormComponent = (0, _vue.defineComponent)({
  props: {
    renderOpts: {
      type: Object,
      default: () => ({})
      ...
      return (0, _vue.h)(_form.default, {
        ...
        default() {
          return [(0, _vue.h)(_formItem.default, {
            ...
            title: (0, _core.getI18n)('vxe.formDesign.widgetProp.multiple'),
            field: 'multiple',
            itemRender: {
              name: 'VxeSwitch'
            }
          }), renderDataSourceFormItem(), (0, _vue.h)(_formItem.default, {
