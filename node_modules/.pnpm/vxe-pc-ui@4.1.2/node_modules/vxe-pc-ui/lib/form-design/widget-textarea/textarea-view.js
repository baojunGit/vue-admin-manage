...
exports.WidgetTextareaViewComponent = void 0;
...
const WidgetTextareaViewComponent = exports.WidgetTextareaViewComponent = (0, _vue.defineComponent)({
  props: {
    renderOpts: {
      type: Object,
      default: () => ({})
