...
exports.WidgetVxeTextareaViewComponent = void 0;
...
const WidgetVxeTextareaViewComponent = exports.WidgetVxeTextareaViewComponent = (0, _vue.defineComponent)({
  props: {
    renderOpts: {
      type: Object,
      default: () => ({})
  ...
  setup(props) {
    ...
    return () => {
      ...
      return (0, _vue.h)(_formItem.default, {
        ...
        default() {
          return (0, _vue.h)(_textarea.default, {
