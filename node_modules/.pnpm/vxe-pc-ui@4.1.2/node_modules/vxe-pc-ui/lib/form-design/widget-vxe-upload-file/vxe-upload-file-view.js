...
exports.WidgetVxeUploadFileViewComponent = void 0;
var _vue = require("vue");
var _use = require("../../form-design/src/use");
var _formItem = _interopRequireDefault(require("../../form/src/form-item"));
var _upload = _interopRequireDefault(require("../../upload/src/upload"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const WidgetVxeUploadFileViewComponent = exports.WidgetVxeUploadFileViewComponent = (0, _vue.defineComponent)({
  props: {
    renderOpts: {
      type: Object,
      default: () => ({})
  ...
  setup(props) {
    ...
    return () => {
      ...
      return (0, _vue.h)(_formItem.default, {
        ...
        default() {
          return (0, _vue.h)(_upload.default, {
