...
exports.WidgetVxeUploadFileFormComponent = void 0;
var _vue = require("vue");
var _core = require("@vxe-ui/core");
var _vxeUploadFileData = require("./vxe-upload-file-data");
...
const WidgetVxeUploadFileFormComponent = exports.WidgetVxeUploadFileFormComponent = (0, _vue.defineComponent)({
  props: {
    renderOpts: {
      type: Object,
      default: () => ({})
      ...
      return (0, _vue.h)(_form.default, {
        ...
        default() {
          return [(0, _vue.h)(_formItem.default, {
            ...
            title: (0, _core.getI18n)('vxe.formDesign.widgetProp.uploadProp.multiFile'),
            field: 'multiple',
            itemRender: {
              name: 'VxeSwitch'
            }
          }), options.multiple ? (0, _vue.h)(_formItem.default, {
            title: (0, _core.getI18n)('vxe.formDesign.widgetProp.uploadProp.limitFileCount'),
            field: 'limitCount',
            itemRender: {
              name: 'VxeInput',
              props: {
            ...
            title: (0, _core.getI18n)('vxe.formDesign.widgetProp.uploadProp.limitFileSize'),
            field: 'limitSize',
            itemRender: {
              name: 'VxeSelect',
