...
var _treeSelect = _interopRequireDefault(require("../../tree-select/src/tree-select"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const WidgetVxeTreeSelectViewComponent = exports.WidgetVxeTreeSelectViewComponent = (0, _vue.defineComponent)({
  props: {
    renderOpts: {
      type: Object,
      default: () => ({})
  ...
  setup(props) {
    ...
    return () => {
      ...
      return (0, _vue.h)(_formItem.default, {
        ...
        default() {
          return (0, _vue.h)(_treeSelect.default, {
