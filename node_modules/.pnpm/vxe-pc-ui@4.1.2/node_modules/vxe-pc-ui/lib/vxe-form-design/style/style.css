...
.vxe-form-design--widget-subtable-form-item > .vxe-form--item-inner {
  overflow: hidden;
}
.vxe-form-design--widget-subtable-form-item > .vxe-form--item-inner > .vxe-form--item-content {
  overflow: hidden;
}
...
.vxe-form-design--layout-style-preview .vxe-form--item-content::after {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
