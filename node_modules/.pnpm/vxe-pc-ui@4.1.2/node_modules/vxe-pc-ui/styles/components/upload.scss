...
.vxe-upload--file-item-download-icon,
.vxe-upload--file-item-remove-icon {
  flex-shrink: 0;
  padding-left: 0.5em;
  cursor: pointer;
}
...
.vxe-upload--image-item-loading-icon {
  font-size: 1.4em;
}
.vxe-upload--image-item-loading-text {
  padding: 0.4em 0;
}
...
.vxe-upload--image-item-remove-icon {
  position: absolute;
