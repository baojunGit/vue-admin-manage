...
<template>
  <div id="user-container">
    <QueryForm>
      <QueryFormTopPanel>
        ...
        <el-form :inline="true">
          ...
          <el-form-item label="网站角色">
            <el-select v-model="queryParams.roleName" placeholder="请选择角色" clearable @change="queryData">
      ...
      <QueryFormBtnPanel>
        <el-button plain :icon="Plus" type="primary" @click="handleUser($event)"> 添加 </el-button>
        <el-button plain :icon="Delete" type="danger" @click="handleDelete($event)"> 批量删除 </el-button>
    ...
    >
      ...
      <vxe-column field="info" title="信息" width="200" show-overflow></vxe-column>
      ...
      <vxe-column title="操作" min-width="110" fixed="right">
        <template #default="{ row }">
          <el-button @click="handleUser(row)" plain size="small" type="primary" :icon="Edit"> </el-button>
    ...
    <AddOrEdit ref="addEditRef" @refresh="fetchData" :role-list="roleList"></AddOrEdit>
  </div>
</template>
